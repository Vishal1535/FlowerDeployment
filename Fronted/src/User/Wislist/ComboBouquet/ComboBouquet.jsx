...
export const ComboBouquet = ({ item = [] }) => {
  const [search, setSearch] = useState("");

  // ================= SEARCH =================

  const filteredComboBouquets = item.filter(
    (comboBouquet) => {
    ...
    return (
      ...
      >
        <p className="text-sm font-medium text-gray-400">
          No combo bouquets in your wishlist yet.
        </p>

        <p className="mt-1 text-xs text-gray-300">
          Add your favourite combo bouquets to see them here.
        </p>
      </div>
    );
  }
