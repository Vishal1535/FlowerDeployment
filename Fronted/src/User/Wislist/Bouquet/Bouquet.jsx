...
export const Bouquet = ({ item = [] }) => {
  ...
  const filteredBouquets = item.filter((bouquet) => {
    ...
    return (
      ...
      >
        <p className="text-sm font-medium text-gray-400">
          No bouquets in your wishlist yet.
        </p>

        <p className="mt-1 text-xs text-gray-300">
          Add your favourite bouquets to see them here.
        </p>
      </div>
    );
  }
      ...
      {!filteredBouquets.length ? (
        ...
        >
          ...
          <p className="mt-1 text-xs text-gray-400">
            Try searching with a different name or occasion.
          </p>
        </div>
      ) : (
