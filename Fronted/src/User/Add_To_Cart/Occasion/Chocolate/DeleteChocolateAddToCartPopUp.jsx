...
export const DeleteChocolateAddToCartPopUp = () => {
  ...
  const HandleDelete = async () => {
    ...
    const result = await dispatch(
      DeleteChocolateFromCartThunk(deleteCartId)
    );

    if (
      DeleteChocolateFromCartThunk.fulfilled.match(
        result
      )
    ) {
      toast.success(
      ...
      <div className="w-full max-w-sm bg-white rounded-xl shadow-2xl">
        ...
        <div className="px-5 py-6 text-center">
          ...
          <h3 className="mt-4 text-lg font-semibold text-gray-800">
            Remove this chocolate?
          </h3>

          <p className="mt-2 text-sm text-gray-500">
            Are you sure you want to remove this
            chocolate from your cart?
          </p>
