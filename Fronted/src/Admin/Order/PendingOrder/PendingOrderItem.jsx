...
export const PendingOrderItem = ({ order }) => {
  ...
  return (
    <div className="w-full bg-white border border-amber-100 rounded-xl shadow-sm px-3 py-3 sm:px-4 sm:py-3">
      {/* ================================================= */}
      {/* HEADER */}
      {/* ================================================= */}
      ...
      <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-3">
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <span className="shrink-0 text-[9px] text-gray-400">Pending</span>
          </div>
        ...
        <span className="self-start shrink-0 px-2.5 py-1 rounded-full text-[10px] font-bold bg-amber-50 text-amber-600 border border-amber-200">
          Pending
        </span>
      </div>
