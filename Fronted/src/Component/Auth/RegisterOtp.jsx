        ...
        <div className="bg-white border border-gray-200 rounded-2xl shadow-lg p-7">
          ...
          <form onSubmit={handleVerify} className="mt-6">
            ...
            <input
              ...
              className="input input-bordered w-full mt-2 text-center text-2xl tracking-[10px] font-semibold focus:outline-none focus:border-gray-500"
            />

            <button
              type="submit"
              disabled={loading}
              className="btn w-full mt-5 bg-gray-900 hover:bg-gray-800 border-none text-white rounded-lg"
            >
